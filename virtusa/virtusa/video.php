...
<div id="navbar"> 
    ...
    <?php
        ...
        echo '<video controls width="640" height="480" src="'.$rows[3].'">video</video><br><b style="font-size:30px;padding:20px">'.$rows[6].'</b><br><p style="font-size:20px;padding:20px" >'.$rows[7].'</p>';
